...
public class Day6 {
    ...
    @BeforeTest
    public void startDriver(String deviceId) throws Exception {
    ...
    public void setCapabilities(String device) {
        ...
        String appPath = System.getProperty("user.dir") + "/apps/android/app-alpha-debug.apk";
    ...
    @Test
    public void testForParallel() throws Exception {
